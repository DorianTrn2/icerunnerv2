...
data modify storage ir:data Items.dashv2 set value {id: "minecraft:ender_eye",Count:1b,tag:{display:{Name:'[{"text":"Dash","italic":false,"color":"lime"}]',Lore:['[{"text":"Dash in the direction you are looking at.","italic":true,"color":"gray"}]']}}}
