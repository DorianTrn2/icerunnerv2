...
data modify storage ir:data Items.blind set value {id:"minecraft:squid_spawn_egg",tag:{EntityTag:{ActiveEffects:[{Id:14,Duration:100,Amplifier:100,ShowParticles:0b}],Tags:["blind_squid"]},display:{Name:'[{"text":"Squid Attack","italic":false,"color":"red"}]',Lore:['[{"text":"Enemies can\'t see anything for few seconds.","italic":true,"color":"gray"}]']}}}
