...
title @a title ["",{"text":"||","obfuscated":true,"color":"white"},{"text":" GREEN ","color":"green"},{"text":"TEAM WINS ! ","color":"yellow"},{"text":"||","obfuscated":true,"color":"white"}]
clear @a
gamemode spectator @a[team=!green]
effect give @a[team=green] minecraft:levitation 10 0 true
effect give @a[team=green] minecraft:glowing 10 0 true
