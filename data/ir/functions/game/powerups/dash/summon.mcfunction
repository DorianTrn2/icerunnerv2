...
execute at @s run particle minecraft:white_ash ~ ~ ~ 0.5 1 0.5 10 500
execute at @s run playsound minecraft:entity.bat.takeoff master @a ~ ~ ~ 1 0
execute at @s run playsound minecraft:entity.bat.takeoff master @a ~ ~ ~ 1 1
